...
(perlmonks.org), Available: 
L<http:E<sol>E<sol>www.perlmonks.orgE<sol>index.pl?node_id=278900>
...
L<http:E<sol>E<sol>rt.cpan.orgE<sol>NoAuthE<sol>Bugs.html?Dist=Exception-Class-Sugar>
